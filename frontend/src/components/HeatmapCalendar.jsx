            ...
            <div className="flex flex-col gap-0 overflow-x-auto">
              ...
              <div className="flex gap-1 mb-1 h-5">
                {weeks.map((week, weekIdx) => {
                  ...
                  return (
                    <div key={weekIdx} className="w-[14px] h-5 text-[9px] font-bold text-slate-500 dark:text-slate-400 flex items-center overflow-visible whitespace-nowrap">
              ...
              <div className="flex gap-1">
                {weeks.map((week, weekIdx) => (
                  <div key={weekIdx} className="flex flex-col gap-1 w-[14px]">
                    {week.map((day, dayIdx) => {
                      if (!day) {
                      ...
                      return (
                        <motion.div
                          key={`${weekIdx}-${dayIdx}`}
                          className={`heatmap-cell w-[13px] h-[13px] rounded-[3px] cursor-pointer transition-all duration-150 hover:scale-125 ${bg} ${shadow}`}
                          onMouseEnter={(e) => {
      ...
      <AnimatePresence>
        {tooltip && (
          <motion.div
            ...
            style={{ zIndex: 'var(--z-overlay-panel)' }}
